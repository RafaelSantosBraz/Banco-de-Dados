...
insert into aluno values ('A21', 'José Carlos Fonseca', 'Rua 1', 'Coisa Brava', 'Londrina', '25-03-1987', 'M');
insert into aluno values ('A22', 'Ailton Bonifacio', 'Rua 2', 'Coisa Mansa', 'Londrina', '26-11-1978', 'M');
insert into aluno values ('A23', 'Wandernelson Pereira', 'Rua 3', 'Barra Limpa', 'Bandeirantes', '23-04-1986', 'M');
insert into aluno values ('A24', 'Alfreda Alfredike', 'Rua 4', 'Barra Suja', 'Bandeirantes','28-02-1989', 'F');
insert into aluno values ('A25', 'Marcio Campos Belo', 'Rua 5', 'Centro', 'Londrina', '15-06-1986', 'M');
insert into aluno values ('A26', 'Agradecido Pereira da Silva', 'Rua 6', 'Centro', 'Bandeirantes', '11-09-1979', 'M');
insert into aluno values ('A27', 'Genézio Roberto Belo', 'Rua 7', 'Barra Suja', 'Londrina', '12-04-1980', 'M');
insert into aluno values ('A28', 'Maria Clementina da Silva', 'Rua 8', 'Coisa Mansa', 'Londrina', '25-03-1988', 'F');
insert into aluno values ('A29', 'Marceulo Roberto', 'Rua 9', 'Centro', 'Bandeirantes','25-06-1987', 'M');
insert into aluno values ('A30', 'Mafaldo Sibipiruna', 'Rua 10', 'Centro', 'Bandeirantes','26-02-1978', 'M');
insert into aluno values ('A31', 'Afanázio Augusto Souza', 'Rua 11', 'Centro', 'Bandeirantes','23-10-1986', 'M');
insert into aluno values ('A32', 'Um dois três de Oliveira Quatro', 'Rua 9', 'Vila Vintem', 'Londrina', '11-08-1987', 'M');
insert into aluno values ('A33', 'Zaqueu Melo Pestana', 'Rua 2', 'Vila Sésamo', 'Bandeirantes', '05-11-1978', 'M');
insert into aluno values ('A34', 'Luciano Malfadeza', 'Rua 2', 'Barra Suja', 'Bandeirantes','21-04-1979', 'M');
insert into aluno values ('A35', 'Claudinéia Sebastiana Crispim', 'Rua 9', 'Coisa Mansa', 'Londrina', '01-06-1979', 'F');
insert into aluno values ('A36', 'Estelafalda Peixoto de Azevedo', 'Rua 8', 'Barra Limpa', 'Bandeirantes','01-05-1977', 'F');
insert into aluno values ('A37', 'Marianete Cortex Hair', 'Rua 7', 'Coisa Brava', 'Bandeirantes', '03-07-1977', 'F');
insert into aluno values ('A38', 'Renatenhaa Japorongo', 'Rua 8', 'Centro', 'Londrina', '20-08-1980', 'F');
insert into aluno values ('A39', 'Andrelino Mechado', 'Rua 2', 'Centro', 'Bandeirantes', '21-06-1976', 'M');
insert into aluno values ('A40', 'Carlona BigHair', 'Rua 8', 'Barra Suja', 'Londrina', '24-05-1988', 'F');
commit;
...
insert into disciplina values ('BDI', 'Banco de Dados I', 4, 'SI');
insert into disciplina values ('BDII', 'Banco de Dados II', 4, 'SI', 'BDI');
insert into disciplina values ('ENG1', 'Engenharia de Software I', 4, 'SI');
...
insert into disciplina values ('BOT', 'Botânica', 6, 'BIO');
insert into disciplina values ('GEN', 'Genética', 4, 'BIO', 'BOT');
insert into disciplina values ('INS', 'Instrumentação Cirurgica', 6, 'AGRO');
insert into disciplina values ('SOC', 'Primeiros Socorros', 4, 'AGRO');
commit;
